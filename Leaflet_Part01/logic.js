quakeURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_plates.json";
...
function Features(earthquakefeatures) {
  ...
  function createCircleMarker(feature,latlng){
    var color;
    var r = Math.floor(255-50*feature.properties.mag);
    var g = 200;
...
function markerColor(magnitude)  {
  if (magnitude <= 1) {
    ...
    return "rgb(195,255,195)"
  }
  else if (magnitude <=4) {
    return "rgb(165,255,165)"
  }
  else {
